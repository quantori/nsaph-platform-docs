...
<head>
  ...
  <title>NumPy C-API &mdash; NSAPH Data Platform 0.0.1 documentation</title>
...
<li class="toctree-l1"><a class="reference internal" href="../../../../../../../../../cms/README.html">CMS Manipulation Package</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            <a href="../../../../../../../../../../_sources/common/utils/venv/lib/python3.9/site-packages/numpy/core/include/numpy/multiarray_api.txt" rel="nofollow"> View page source</a>
      </li>
  </ul>
  <hr/>
</div>
  ...
  <section id="numpy-c-api">
<h1>NumPy C-API<a class="headerlink" href="#numpy-c-api" title="Permalink to this heading"></a></h1>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">PyArray_Descr</span> <span class="o">*</span>
<span class="n">PyArray_ResultType</span><span class="p">(</span><span class="n">npy_intp</span> <span class="n">narrs</span><span class="p">,</span> <span class="n">PyArrayObject</span> <span class="o">**</span><span class="n">arr</span><span class="p">,</span> <span class="n">npy_intp</span>
                   <span class="n">ndtypes</span><span class="p">,</span> <span class="n">PyArray_Descr</span> <span class="o">**</span><span class="n">dtypes</span><span class="p">)</span>
</pre></div>
</div>
<p>Produces the result type of a bunch of inputs, using the UFunc
type promotion rules. Use this function when you have a set of
input arrays, and need to determine an output array dtype.</p>
<p>If all the inputs are scalars (have 0 dimensions) or the maximum “kind”
of the scalars is greater than the maximum “kind” of the arrays, does
a regular type promotion.</p>
<p>Otherwise, does a type promotion on the MinScalarType
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="nb">int</span>
<span class="n">PyArray_GetArrayParamsFromObject</span><span class="p">(</span><span class="n">PyObject</span> <span class="o">*</span><span class="n">op</span><span class="p">,</span> <span class="n">PyArray_Descr</span>
                                 <span class="o">*</span><span class="n">requested_dtype</span><span class="p">,</span> <span class="n">npy_bool</span>
                                 <span class="n">writeable</span><span class="p">,</span> <span class="n">PyArray_Descr</span>
                                 <span class="o">**</span><span class="n">out_dtype</span><span class="p">,</span> <span class="nb">int</span> <span class="o">*</span><span class="n">out_ndim</span><span class="p">,</span> <span class="n">npy_intp</span>
                                 <span class="o">*</span><span class="n">out_dims</span><span class="p">,</span> <span class="n">PyArrayObject</span>
                                 <span class="o">**</span><span class="n">out_arr</span><span class="p">,</span> <span class="n">PyObject</span> <span class="o">*</span><span class="n">context</span><span class="p">)</span>
</pre></div>
</div>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="nb">int</span>
