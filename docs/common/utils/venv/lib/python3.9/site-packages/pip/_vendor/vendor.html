...
<li class="toctree-l1"><a class="reference internal" href="../../../../../../../cms/README.html">CMS Manipulation Package</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            <a href="../../../../../../../../_sources/common/utils/venv/lib/python3.9/site-packages/pip/_vendor/vendor.txt" rel="nofollow"> View page source</a>
      </li>
  </ul>
  <hr/>
</div>
  ...
  <p>CacheControl==0.12.6  # Make sure to update the license in pyproject.toml for this.
colorama==0.4.4
distlib==0.3.3
distro==1.6.0
html5lib==1.1
