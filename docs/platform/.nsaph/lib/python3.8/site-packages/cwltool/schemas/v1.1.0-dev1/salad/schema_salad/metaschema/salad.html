...
<p>Author:</p>
<ul class="simple">
<li><p>Peter Amstutz <a class="reference external" href="mailto:peter&#46;amstutz&#37;&#52;&#48;curoverse&#46;com">peter<span>&#46;</span>amstutz<span>&#64;</span>curoverse<span>&#46;</span>com</a>, Curoverse</p></li>
</ul>
<p>Contributors:</p>
<ul class="simple">
...
documentation.</p>
<div class="section" id="introduction-to-v1-0">
<h2>Introduction to v1.0<a class="headerlink" href="#introduction-to-v1-0" title="Permalink to this headline">¶</a></h2>
<p>This is the second version of of the Schema Salad specification.  It is
...
<ul class="simple">
<li><p>Use of <a class="reference external" href="#Identifier_maps">mapSubject and mapPredicate</a> to transform maps to lists of records.</p></li>
<li><p>Resolution of the <a class="reference external" href="#Domain_Specific_Language_for_types">domain Specific Language for types</a></p></li>
<li><p>Consolidation of the formal <a class="reference external" href="#Schema">schema into section 5</a>.</p></li>
</ul>
</div>
...
<p>Conforming Salad documents are serialized and loaded using YAML syntax and
...
<h3>Record field annotations<a class="headerlink" href="#record-field-annotations" title="Permalink to this headline">¶</a></h3>
...
link field.</p></li>
<li><p>If the value of <code class="docutils literal notranslate"><span class="pre">jsonldPredicate</span></code> is an object, and contains that
object contains the field <code class="docutils literal notranslate"><span class="pre">_type</span></code> with the value <code class="docutils literal notranslate"><span class="pre">&#64;vocab</span></code>, the field is a
vocabulary field, which is a subtype of link field.</p></li>
</ul>
</div>
</div>
...
<script>$('#searchbox').show(0);</script>
    ...
    <div class="footer">
      ...
      |
      <a href="../../../../../../../../../../_sources/.nsaph/lib/python3.8/site-packages/cwltool/schemas/v1.1.0-dev1/salad/schema_salad/metaschema/salad.md.txt"
