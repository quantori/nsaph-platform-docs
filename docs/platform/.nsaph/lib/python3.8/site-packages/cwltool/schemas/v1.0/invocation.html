...
<p>Output files produced by tool execution must be written to the <strong>designated
output directory</strong>.  The initial current working directory when executing
the tool must be the designated output directory.</p>
...
<script>$('#searchbox').show(0);</script>
    ...
    <div class="footer">
      ...
      |
      <a href="../../../../../../../_sources/.nsaph/lib/python3.8/site-packages/cwltool/schemas/v1.0/invocation.md.txt"
