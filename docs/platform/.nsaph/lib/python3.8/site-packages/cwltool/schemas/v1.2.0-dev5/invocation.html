...
the ‘networkAccess’ field of a <a class="reference external" href="#NetworkAccess">‘NetworkAccess’</a> requirement set
to <code class="docutils literal notranslate"><span class="pre">true</span></code> but even then this does not imply a publically routable IP address or
the ability to accept inbound connections.</p>
...
<p>The standard input stream, the standard output stream, and/or the standard error
stream may be redirected as described in the <a class="reference external" href="#stdin"><code class="docutils literal notranslate"><span class="pre">stdin</span></code></a>,
<a class="reference external" href="#stdout"><code class="docutils literal notranslate"><span class="pre">stdout</span></code></a>, and <a class="reference external" href="#stderr"><code class="docutils literal notranslate"><span class="pre">stderr</span></code></a> fields.</p>
</div>
...
<p>The standard error stream and standard output stream may be captured by
platform logging facilities for storage and reporting.</p>
...
<script>$('#searchbox').show(0);</script>
    ...
    <div class="footer">
      ...
      |
      <a href="../../../../../../../_sources/.nsaph/lib/python3.8/site-packages/cwltool/schemas/v1.2.0-dev5/invocation.md.txt"
