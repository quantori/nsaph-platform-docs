...
<p>An <strong>input object</strong> is an object describing the inputs to an invocation of
a process.</p>
<p>An <strong>output object</strong> is an object describing the output resulting from an
invocation of a process.</p>
...
https://github.com/common-workflow-language/common-workflow-language/tree/master/v1.1.0-dev1</p>
<div class="section" id="map">
<h3>map<a class="headerlink" href="#map" title="Permalink to this headline">¶</a></h3>
<p>Note: This section is non-normative.</p>
<blockquote>
<div><p>type: array&lt;ComplexType&gt; |<br />map&lt;<code class="docutils literal notranslate"><span class="pre">key_field</span></code>, ComplexType&gt;</p>
</div></blockquote>
...
<blockquote>
<div><p>array&lt;InputParameter&gt; |<br />map&lt;<code class="docutils literal notranslate"><span class="pre">id</span></code>, <code class="docutils literal notranslate"><span class="pre">type</span></code> | InputParameter&gt;</p>
</div></blockquote>
...
<blockquote>
<div><p>array&lt;SoftwarePackage&gt; |<br />map&lt;<code class="docutils literal notranslate"><span class="pre">package</span></code>, <code class="docutils literal notranslate"><span class="pre">specs</span></code> | SoftwarePackage&gt;</p>
</div></blockquote>
...
<blockquote>
<div><p>type: array&lt;ComplexType&gt; |<br />map&lt;<code class="docutils literal notranslate"><span class="pre">key_field</span></code>, <code class="docutils literal notranslate"><span class="pre">field2</span></code> | ComplexType&gt;</p>
</div></blockquote>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">inputs</span><span class="p">:</span>
  ...
  <span class="n">workflow_input02</span><span class="p">:</span>     <span class="c1"># we use the longer way</span>
    ...
    <span class="nb">format</span><span class="p">:</span> <span class="n">http</span><span class="p">:</span><span class="o">//</span><span class="n">edamontology</span><span class="o">.</span><span class="n">org</span><span class="o">/</span><span class="n">format_2572</span>
  <span class="n">workflow_input03</span><span class="p">:</span> <span class="p">{}</span>  <span class="c1"># back to the short form as this entry</span>
                        <span class="c1"># uses the default of no &quot;type&quot; just like the prior</span>
...
<p>Note: The <code class="docutils literal notranslate"><span class="pre">map&lt;…&gt;</span></code> (compact) versions are optional, the verbose option #1 is
...
<p>Input metadata (for example, a lab sample identifier) may be represented within
...
<p>A <strong>parameter</strong> is a named symbolic input or output of process, with an
...
<li><p>Determining if a process has previously been executed, and if so skipping it
and reusing previous results.</p></li>
...
<p>The generic execution sequence of a CWL process (including workflows and
command line line tools) is as follows.</p>
<ol class="simple">
<li><p>Load input object.</p></li>
<li><p>Load, process and validate a CWL document, yielding one or more process objects.</p></li>
...
<p>In the following <a class="reference external" href="https://en.wikipedia.org/wiki/Backus%E2%80%93Naur_Form">BNF
grammar</a>, character
...
these special characters, and all other characters are literal values.</p>
<p>
<table class="table">
...
<ul class="simple">
<li><p>Leading and trailing quotes are stripped from strings</p></li>
...
<p>Exceptions thrown from an exception must result in a <code class="docutils literal notranslate"><span class="pre">permanentFailure</span></code> of the
process.</p>
</div>
...
<p><code class="docutils literal notranslate"><span class="pre">/usr/share/commonwl/</span></code></p>
<p><code class="docutils literal notranslate"><span class="pre">/usr/local/share/commonwl/</span></code></p>
<p><code class="docutils literal notranslate"><span class="pre">$XDG_DATA_HOME/commonwl/</span></code> (usually <code class="docutils literal notranslate"><span class="pre">$HOME/.local/share/commonwl</span></code>)</p>
<p><code class="docutils literal notranslate"><span class="pre">$XDG_DATA_HOME</span></code> is from the <a class="reference external" href="http://standards.freedesktop.org/basedir-spec/basedir-spec-0.6.html">XDG Base Directory
Specification</a></p>
</div>
</div>
...
<script>$('#searchbox').show(0);</script>
    ...
    <div class="footer">
      ...
      |
      <a href="../../../../../../../_sources/.nsaph/lib/python3.8/site-packages/cwltool/schemas/v1.1.0-dev1/concepts.md.txt"
